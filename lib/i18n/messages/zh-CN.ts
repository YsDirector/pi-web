...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "todo.label": "待办",
    "todo.show": "查看当前待办清单",
    "todo.unsaved": "会话保存后可查看待办清单",
    "todo.progress": "{done}/{total} 已完成",
    "todo.pending": "进行中",
    "todo.done": "已完成",
    "todo.empty": "暂无待办事项",
    "todo.emptyHint": "可以让 AI 用 todo 工具添加。",
    "todo.loading": "加载待办中...",
    "todo.close": "关闭",
    "todo.loadError": "加载待办失败",
    "session.info": "会话信息",
    "session.name": "名称",
    "session.file": "文件",
    ...
    "chat.batchAskTitle": "批量问卷",
    "chat.reviewTab": "审阅",
    "chat.customInput": "✎ 自行输入...",
    "chat.answered": "已答",
    "chat.unanswered": "未答",
    "chat.allAnswered": "全部已回答，可提交",
    "chat.notAllAnswered": "请回答全部问题后再提交",
    "chat.yes": "是",
    "chat.no": "否",
    "chat.cancel": "取消",
    "chat.confirm": "确认",
    ...
    "chat.phoneMode": "手机模式",
    "chat.phoneModeOn": "手机模式已开启：回车换行，Shift+回车发送",
    "chat.phoneModeOff": "手机模式已关闭：回车发送，Shift+回车换行",
