...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "todo.label": "Todos",
    "todo.show": "Show the current todo list",
    "todo.unsaved": "Todo list is available after the session is saved",
    "todo.progress": "{done}/{total} completed",
    "todo.pending": "In progress",
    "todo.done": "Completed",
    "todo.empty": "No todos yet.",
    "todo.emptyHint": "Ask the agent to add some with the todo tool.",
    "todo.loading": "Loading todos...",
    "todo.close": "Close",
    "todo.loadError": "Failed to load todos",
    ...
    "chat.batchAskTitle": "Batch questions",
    "chat.reviewTab": "Review",
    "chat.customInput": "✎ Type your own...",
    "chat.answered": "answered",
    "chat.unanswered": "unanswered",
    "chat.allAnswered": "All answered, ready to submit",
    "chat.notAllAnswered": "Answer all questions before submitting",
    "chat.yes": "Yes",
    "chat.no": "No",
    "chat.cancel": "Cancel",
    ...
    "chat.phoneMode": "Phone mode",
    "chat.phoneModeOn": "Phone mode on: Enter = newline, Shift+Enter = send",
    "chat.phoneModeOff": "Phone mode off: Enter = send, Shift+Enter = newline",
