...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.allAnswered": "全部已回答，可提交",
    "chat.answered": "已答",
    "chat.batchAskTitle": "批量問卷",
    "chat.customInput": "✎ 自行輸入...",
    "chat.dialogTimeout": "⏳ 未確認，{s} 秒後自動關閉",
    "chat.no": "否",
    "chat.notAllAnswered": "請回答全部問題後再提交",
    "chat.phoneMode": "手機模式",
    "chat.phoneModeOff": "手機模式已關閉：Enter 發送，Shift+Enter 換行",
    "chat.phoneModeOn": "手機模式已開啟：Enter 換行，Shift+Enter 發送",
    "chat.reviewTab": "審閱",
    "chat.unanswered": "未答",
    "chat.yes": "是",
    "todo.close": "關閉",
    "todo.done": "已完成",
    "todo.empty": "暫無待辦事項",
    "todo.emptyHint": "可以讓 AI 用 todo 工具添加。",
    "todo.label": "待辦",
    "todo.loadError": "載入待辦失敗",
    "todo.loading": "載入待辦中...",
    "todo.pending": "進行中",
    "todo.progress": "{done}/{total} 已完成",
    "todo.show": "查看目前待辦清單",
    "todo.title": "待辦清單",
    "todo.unsaved": "會話儲存後可查看待辦清單",
  },
};
