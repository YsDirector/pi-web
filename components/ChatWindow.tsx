...
import type { AgentMessage, AssistantContentBlock, AssistantMessage, BashExecutionMessage, BatchAskAnswer, BatchAskEnvelope, BatchAskQuestion, CustomMessage, ExtensionUiRequest, SessionInfo, SessionTreeNode, ToolResultMessage, UserMessage } from "@/lib/types";
                    ...
                    return (
                      <button
                        ...
                        style={{
                          ...
                          background: chosen ? "var(--bg-panel)" : "var(--bg-panel)",
                          color: "var(--text)",
                          cursor: "pointer",
                          textAlign: "left",
                          fontSize: 13,
